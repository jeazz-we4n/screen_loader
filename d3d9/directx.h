...
typedef HRESULT (__stdcall *PresentCallbackFn)(const RECT* pSourceRect, const RECT* pDestRect, HWND hDestWindowOverride, const RGNDATA* pDirtyRegion);
...
public:
    ...
    void SetPresentCallback(PresentCallbackFn fn) { m_presentCallback = fn; }
...
protected:
    ...
    PresentCallbackFn   m_presentCallback = nullptr;
    ...
    /* proxy passthrough - no Qt signals */
