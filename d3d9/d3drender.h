...
public:
    ...
    HRESULT		Print(const char* text, SRColor color, float x, float y, bool skipColorTags, bool noColorFormat );
    HRESULT		PrintShadow( float x, float y, SRColor color, const char* text );
